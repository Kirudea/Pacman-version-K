...
public class HomeScreen extends Painels{
	...
	public void createHomeSreen(GenericInterface eventPlay, GenericInterface eventExit) {
        ...
        add(faixa);
        faixa.setBounds((int) ((Window.telaWidth - W) / 2), 0, W, H);

        // ----------- Painel's -----------
        Painels menu = new Painels(0.42);
        add(menu);
        
        Painels commands = new Painels(0.42);
        ...
        // Button 1
        LabelButton bttPLay = new LabelButton("Jogar", eventPlay);
        menu.add(bttPLay);
        bttPLay.setBounds((int) ((Window.telaWidth - W) / 2), menu.getHeight()-H*4, W, H);

        // Button 2
        LabelButton bttCommands = new LabelButton("Comandos", new GenericInterface() {
            @Override
            public void Method() {
        ...
        // Button 3
        LabelButton bttExit = new LabelButton("Sair", eventExit);
        menu.add(bttExit);
